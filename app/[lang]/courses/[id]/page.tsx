...
export default function LangCourseDetailPage({
      ...
      >
        <div className="text-center">
          ...
          <p className="text-purple-700 mb-6">
            {isAr
              ? "الدورة التي تبحثين عنها غير موجودة."
  ...
  const instructorDisplayName = isAr
    ? base?.instructorAr || course.instructor.name
            ...
            <div className="space-y-6">
              ...
              <div>
                <h3 className="text-xl font-semibold text-purple-900 mb-4">
                  {isAr ? "ما ستتعلمينه" : "What you'll learn"}
                </h3>
                <ul className="space-y-2">
                  {(isAr ? ar.learningOutcomes : course.learningOutcomes).map(
                    (outcome, index) => (
                      <li
                        key={index}
                        className={
                  ...
                  >
                    <div className="flex items-center text-sm text-purple-700">
                      <svg
                        className={
                          isAr
                            ? "w-4 h-4 text-green-500 ml-3 flex-shrink-0"
                            : "w-4 h-4 text-green-500 mr-3 flex-shrink-0"
                        }
                        fill="currentColor"
                        viewBox="0 0 20 20"
                      >
              ...
              <div className="relative aspect-video bg-purple-100 rounded-xl overflow-hidden">
                <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-purple-200 to-pink-200">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-purple-600">
                      {isAr ? "معاينة 2:30 متاحة" : "2:30 preview available"}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-8">
                <div>
                  <h3 className="text-2xl font-semibold text-purple-900 mb-4">
                    {isAr ? "حول هذه الدورة" : "About This Course"}
                  </h3>
                ...
                <div>
                  <h3 className="text-2xl font-semibold text-purple-900 mb-4">
                    {isAr ? "نتائج التعلم" : "Learning Outcomes"}
                  </h3>
                  ...
                  <div className="grid sm:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      <div className="flex justify-between">
                        ...
                        <span className="text-purple-900 font-medium">
                          {isAr ? ar.metaData.level : course.metaData.level}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-purple-600">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="text-purple-900 font-medium">
                          {isAr
                            ? ar.metaData.lastUpdated
                            : course.metaData.lastUpdated}
                        </span>
                      </div>
                    </div>
                  </div>
            ...
            {activeTab === "curriculum" && (
              <div className="space-y-6">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="text-sm text-purple-600">
                    {course.curriculum.length} {isAr ? "دروس" : "lessons"} •{" "}
                    {isAr
                      ? ar.metaData.totalDuration
                      : course.metaData.totalDuration}
                  </div>
                        ...
                        <div className="flex-1">
                          ...
                          >
                            <h5 className="font-medium text-purple-900">
                              {isAr ? ar.curriculum[index] : lesson.title}
                            </h5>
                            {lesson.isPreview && (
